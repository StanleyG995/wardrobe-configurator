...
const STYLES = {
  button: cn(
    "font-regular flex cursor-pointer flex-row items-center rounded-md border-1 border-gray-300 bg-gray-50 px-3 py-2 text-center text-sm text-black-800 shadow-md shadow-brand-700/10 ring-brand-500 transition-all duration-200 outline-none hover:bg-gray-50 hover:text-black-700 focus:ring-1",
  ),
  ...
  toggleIndicator: cn("h-2 w-2 rounded-full bg-gray-300 mr-2"),
